<x-admin-layout>
    ...
    <div class="overflow-x-auto bg-white rounded-lg shadow-md">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap">{{ $loop->iteration + ($activities->currentPage() - 1) * $activities->perPage() }}</td>
    ...
    <!-- Pagination -->
    <div class="mt-4">
        {{ $activities->appends(request()->except('page'))->links('pagination::tailwind') }}
    </div>

<x-admin-layout>
    ...
    <script>
        ...
        function editPenyebab(id) {
            const penyebabText = document.getElementById(`penyebab-text-${id}`);
            ...
            if (!penyebabText.classList.contains('editing')) {
                ...
                inputField.addEventListener('blur', function() {
                    ...
                    .then(data => {
                        if (data.success) {
                            penyebabText.textContent = newValue;
                            penyebabText.classList.remove('editing');
                        } else {
                            alert('Gagal memperbarui penyebab.');
                        }
                    })
                    .catch(error => {
                        console.error('Error:', error);

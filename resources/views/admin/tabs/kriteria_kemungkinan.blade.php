        ...
        <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
            <div class="align-middle inline-block min-w-full shadow overflow-hidden sm:rounded-lg border-b border-gray-200">
               ...
               <<!-- Modal for Edit Kriteria Kemungkinan -->
                ...
                <button onclick="toggleModal('editKriteriaKemungkinanModal')" class="text-gray-500 text-2xl ml-4">&times;</button>
                </div>
                        <form id="editKriteriaKemungkinanForm" action="" method="POST">
                    @csrf
            @method('PUT')
            <div class="mb-4">
...
<script>
    $(document).ready(function() {
        ...
        // Open modal
        window.openEditKriteriaKemungkinanModal = function(actionUrl, kategoriId, levelId, presentase, frekuensi) {
            $('#editKriteriaKemungkinanForm').attr('action', actionUrl);
            $('#edit_id_kategori_resiko').val(kategoriId);
            $('#edit_id_level_kemungkinan').val(levelId);
            $('#edit_presentase_kemungkinan').val(presentase);
            $('#edit_jumlah_frekuensi').val(frekuensi);

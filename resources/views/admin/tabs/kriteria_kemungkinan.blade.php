...
<!-- Blade HTML content -->
<div id="context11" class="hidden tab-content">
        ...
        <div class="py-2 -my-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
            <div class="inline-block min-w-full overflow-hidden align-middle border-b border-gray-200 shadow sm:rounded-lg">
                ...
                <form method="GET" action="#" class="mb-4">
                    <div class="flex items-end space-x-4">
                        <div class="relative w-48">
                            <label class="block mb-2 text-gray-700" for="filter_kategori_resiko">Filter Kategori Resiko</label>
                ...
                <div class="flex justify-end">
                    ...
                    <!-- Add Button -->
                    <button id="openTambahKriteriaKemungkinanModal" class="px-4 py-2 mb-2 font-medium tracking-wide text-white transition duration-300 bg-blue-500 rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
                ...
                <table id="riskTable" class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            <th class="px-6 py-3 text-xs font-medium tracking-wider text-left uppercase text-black-500">No</th>
                            <th class="px-6 py-3 text-xs font-medium tracking-wider text-left uppercase text-black-500">Kategori Resiko</th>
                            <th class="px-6 py-3 text-xs font-medium tracking-wider text-left uppercase text-black-500">Level Kemungkinan</th>
                            <th class="px-6 py-3 text-xs font-medium tracking-wider text-left uppercase text-black-500">Presentase Kemungkinan</th>
                            <th class="px-6 py-3 text-xs font-medium tracking-wider text-left uppercase text-black-500">Jumlah Frekuensi</th>
                            @if (auth()->check() && auth()->user()->hasRole('admin'))
                            <th class="px-6 py-3 text-xs font-medium tracking-wider text-center uppercase text-black-500">Actions</th>
                            @endif
                        </tr>
                    </thead>
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 text-center whitespace-no-wrap border-b border-gray-200">
                                    <div class="inline-flex justify-center space-x-4">
                                        <button onclick="openEditKriteriaKemungkinanModal('{{ route('admin.kriteriakemungkinan.update', $kriteria->id) }}', '{{ $kriteria->id_kategori_resiko }}', '{{ $kriteria->id_level_kemungkinan }}', '{{ $kriteria->presentase_kemungkinan }}', '{{ $kriteria->jumlah_frekuensi }}')" class="px-4 py-2 text-white bg-blue-600 rounded hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Edit</button>
                ...
                <div id="tambahKriteriaKemungkinanModal" class="fixed inset-0 flex items-center justify-center hidden">
                    ...
                    <div class="relative z-10 p-6 bg-white border border-black rounded-lg shadow-md">
                        <div class="flex items-center justify-between mb-4">
                            <h2 class="text-xl font-bold">Tambah Kriteria Kemungkinan</h2>
                            <button onclick="toggleModal('tambahKriteriaKemungkinanModal')" class="text-2xl text-gray-500">&times;</button>
                        </div>
                        <form id="tambahKriteriaKemungkinanForm" action="{{ route('admin.kriteriakemungkinan.store') }}" method="POST">
                            ...
                            <div class="mb-4">
                                <label class="block mb-2 text-gray-700" for="id_level_kemungkinan">Level Kemungkinan</label>
                            ...
                            <div class="mb-4">
                                <label class="block mb-2 text-gray-700" for="presentase_kemungkinan">Presentase Kemungkinan</label>
                            ...
                            <div class="mb-4">
                                <label class="block mb-2 text-gray-700" for="jumlah_frekuensi">Jumlah Frekuensi</label>
                            ...
                            <div class="flex justify-end">
                                <button type="submit" class="px-4 py-2 text-white bg-blue-500 rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">Simpan</button>
                                <button type="button" onclick="toggleModal('tambahKriteriaKemungkinanModal')"
                                    class="px-4 py-2 ml-2 text-white bg-gray-500 rounded-md hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-opacity-50">Batal</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div id="editKriteriaKemungkinanModal" class="fixed inset-0 flex items-center justify-center hidden">
                    ...
                    <div class="relative z-10 p-6 bg-white border border-black rounded-lg shadow-md">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <button onclick="toggleModal('editKriteriaKemungkinanModal')" class="text-2xl text-gray-500">&times;</button>
                        </div>
                        <form id="editKriteriaKemungkinanForm" method="POST">
                            ...
                            <div class="mb-4">
                                <label class="block mb-2 text-gray-700" for="edit_id_level_kemungkinan">Level Kemungkinan</label>
                            ...
                            <div class="mb-4">
                                <label class="block mb-2 text-gray-700" for="edit_presentase_kemungkinan">Presentase Kemungkinan</label>
                            ...
                            <div class="mb-4">
                                <label class="block mb-2 text-gray-700" for="edit_jumlah_frekuensi">Jumlah Frekuensi</label>
                            ...
                            <div class="flex justify-end">
                                <button type="submit" class="px-4 py-2 text-white bg-blue-600 rounded hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">Update</button>
                            </form>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    var newRowData = [
                        ...
                        '<button onclick="openEditKriteriaKemungkinanModal(\'' + response.edit_url + '\', \'' + response.id_kategori_resiko + '\', \'' + response.id_level_kemungkinan + '\', \'' + response.presentase_kemungkinan + '\', \'' + response.jumlah_frekuensi + '\')" class="px-4 py-2 text-white bg-blue-600 rounded hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Edit</button> ' +

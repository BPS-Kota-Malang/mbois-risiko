<div id="context13" class="hidden tab-content">
    <section class="bg-white dark:bg-gray-100">
        <div class="py-2 -my-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
            <div
                ...
                <button
                    class="px-4 py-2 mb-2 font-medium tracking-wide text-white bg-blue-500 rounded-md hover:bg-blue-600"
                    onclick="toggleModal('addLevelResikoModal')">Tambah Level Resiko</button>
                <button
                    class="px-4 py-2 mb-2 font-medium tracking-wide text-white bg-green-500 rounded-md hover:bg-green-600"
            ...
            <div
                class="inline-block min-w-full mt-8 overflow-hidden align-middle border-b border-gray-200 shadow sm:rounded-lg">
                @if (auth()->check() && auth()->user()->hasRole('admin'))
                <button
                    class="px-4 py-2 mb-2 font-medium tracking-wide text-white bg-blue-500 rounded-md hover:bg-blue-600"
        ...
        <div class="w-full max-w-sm p-4 bg-white rounded-lg shadow-lg">
            ...
            <form action="{{ route('admin.levelresiko.store') }}" method="POST">
                ...
                <div class="mt-4">
                    ...
                    <input type="text" name="tindakan" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm"
                        required>
                </div>
                <div class="mt-4">
                ...
                <div class="flex justify-end mt-4">
                    ...
                    <button type="button" class="px-4 py-2 ml-2 text-white bg-gray-500 rounded-md"

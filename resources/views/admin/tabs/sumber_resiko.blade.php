<div id="context6" class="hidden tab-content">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 text-center whitespace-no-wrap border-b border-gray-200">
                                    <div class="inline-flex justify-center space-x-4">
                                        ...
                                        <form action="{{ route('admin.sumberresiko.destroy', $sumber->id) }}" method="POST" class="inline"
                ...
                <div id="tambahSumberResikoModal" class="fixed inset-0 flex items-center justify-center hidden">
                    ...
                    <div
                        ...
                        <form action="{{ route('admin.sumberresiko.store') }}" method="POST">
                            @csrf
                            <div class="mb-4">
                                <label class="block mb-2 text-gray-700" for="sumber_resiko">Sumber Resiko</label>
                ...
                <div id="editSumberResikoModal" class="fixed inset-0 flex items-center justify-center hidden">
                    ...
                    <div
                        ...
                        <form id="editSumberResikoForm" method="POST">
                            ...
                            @method('PUT')
                            <div class="mb-4">
                                <label class="block mb-2 text-gray-700" for="sumber_resiko_edit">Sumber Resiko</label>

<!-- Modal Uraian -->
<div class="modal fixed w-full h-full top-0 left-0 flex items-center justify-center hidden" id="uraianModal">
    ...
    <div class="modal-container bg-gray-100 md:max-w-4xl mx-auto md:h-4/5 rounded-lg shadow-lg z-50 overflow-y-auto " style="width: 1000px">
        <div class="modal-content py-4 text-left px-6">
            ...
            <div class="flex justify-between items-center pb-2">
                <p class="text-xl font-bold">Pilih Uraian</p>
                <div class="modal-close cursor-pointer z-50" id="closeModal4">
            ...
            <div class="flex justify-between items-center mb-4">
                <button id="openAddUraianModal" class="bg-blue-500 text-white px-4 py-2 rounded-md">Tambah Uraian</button>
            ...
            <div class="mt-3">
                <table id="uraian-table" class="min-w-full bg-white text-sm">
                    <thead>
                        <tr>
            ...
            <!-- Modal "Tambah Uraian" -->
            <div id="addUraianModal" class="fixed z-10 inset-0 overflow-y-auto hidden">
                <div class="flex items-center justify-center min-h-screen px-4">
                    ...
                    <div class="w-full max-w-2xl p-6 mx-auto bg-white rounded-lg shadow-xl">
                        <form action="{{ route('admin.uraian.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="border-b border-gray-200">
                                <h3 class="text-lg leading-6 font-medium text-gray-900">Tambah Uraian</h3>
                            </div>
                            <div class="py-5">
                                <label for="uraian" class="block text-sm font-medium text-gray-700">Nama Uraian</label>
                                <input type="text" id="uraian" name="uraian" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" required>
                            </div>
                            <div class="bg-gray-50 text-right">
                                <div class="flex justify-between pt-2">
                                    <button id="saveBtn" type="submit" class="bg-green-500 text-white px-4 py-2 rounded-md">Simpan</button>
                                    <button id="cancelUraianBtn" type="button" class="bg-red-500 text-white px-4 py-2 rounded-md">Batal</button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="flex justify-end pt-2">
                <button id="saveUraianBtn" class="bg-green-500 text-white px-4 py-2 rounded-md">Simpan</button>
            </div>
        </div>
    </div>
</div>

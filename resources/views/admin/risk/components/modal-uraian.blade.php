                    ...
                    <div class="w-full max-w-2xl p-6 mx-auto bg-white rounded-lg shadow-xl">
                        <form action="{{ route('admin.uraian.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="py-5">
                                ...
                                <input type="text" id="uraian" name="name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" required>
                            </div>

                        ...
                        @foreach ($manajemenResikos as $ManajemenResiko)
                            <form action="{{ route('admin.manajemenrisiko.store') }}" method="POST">
                                ...
                                <tr class="bg-white border border-gray-300">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap border border-gray-300">
                                        <p style="color: red" id="alertjenis{{ $ManajemenResiko->id }}"
                                            {{ is_null($ManajemenResiko->id_jenis_resiko) ? '' : 'hidden' }}>Jenis
                                            Kosong</p>
                                        ...
                                        <select name="jenis_resiko[]" class="form-select pr-8 py-2 border"
                                            ...
                                            @foreach ($jenisResiko as $jenis)
                                                <option value="{{ $jenis->id }}"
                                                    ...
                                                    {{ $jenis->jenis_resiko }}</option>
                                            @endforeach
                                        </select>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap border border-gray-300">
                                        <p style="color: red" id="alertsumber{{ $ManajemenResiko->id }}"
                                            {{ is_null($ManajemenResiko->id_sumber_resiko) ? '' : 'hidden' }}>Sumber
                                            Kosong</p>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap border border-gray-300">
                                        <p style="color: red" id="alertskategori{{ $ManajemenResiko->id }}"
                                            {{ is_null($ManajemenResiko->id_kategori_resiko) ? '' : 'hidden' }}>Kategori
                                            Kosong</p>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap border border-gray-300">
                                        <p style="color: red" id="alertarea{{ $ManajemenResiko->id }}"
                                            {{ is_null($ManajemenResiko->id_area_dampak) ? '' : 'hidden' }}>Area Kosong
                                        </p>
                                            ...
                                            <div class="flex flex-col items-center">
                                                ...
                                                <div id="selectedPenyebab" class="mt-4 text-left w-full">
                                                    ...
                                                    @else
                                                        ...
                                                        <p class="text-red-500 italic ml-4">Tidak ada Penyebab yang
                                                            dipilih</p>
                                                    @endif
                                                </div>
                                            </div>
                                    ...
                                    @else
                                        <td class="px-6 py-4 whitespace-nowrap border border-gray-300">
                                            <div class="">
                                                ...
                                                @else
                                                    <!-- Jika tidak ada penyebab yang dipilih -->
                                                    <p class="text-red-500 italic ml-4">Tidak ada Penyebab yang dipilih
                                                    </p>
                                                @endif
                                            </div>
                                        </td>
                                            ...
                                            <div class="flex flex-col items-center">
                                                ...
                                                <div id="selectedDampak" class="mt-4 text-left w-full">
                                                    ...
                                                    @else
                                                        ...
                                                        <p class="text-red-500 italic ml-4">Tidak ada Dampak yang
                                                            dipilih</p>
                                                    @endif
                                                </div>
                                            </div>
                                    ...
                                    @else
                                        <td class="px-6 py-4 whitespace-nowrap border border-gray-300">
                                            <div class="">
                                                ...
                                                @else
                                                    <!-- Jika tidak ada dampak yang dipilih -->
                                                    <p class="text-red-500 italic ml-4">Tidak ada Dampak yang dipilih
                                                    </p>
                                                @endif
                                            </div>
                                        </td>
